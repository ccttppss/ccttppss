...
| 17. | 2026.03.-- | PointAD: Comprehending 3D Anomalies from Points and Pixels for Zero-shot 3D Anomaly Detection | <div align="center"> [Link](https://www.youtube.com/watch?v=D0y3daYu9nU) | <div align="center"> [Link](https://doi.org/10.52202/079017-2695) </div>
...
- 제어 기반 언어 유도 결함 생성(Control-based Language-guided Realistic Imperfection Synthesis)
  - 등록번호 : C-2025-027634
...
- VLM 기반 학습형 집계와 패턴 차이 분석을 활용한 범용 제로샷 이상 탐지
  - 등록번호 : C-2025-057921
  - 설명 : SigLIP2 기반의 교차 어텐션 및 차분 패턴 인코딩 기술을 적용하여, 별도의 재학습 없이 다양한 도메인의 구조적 결함과 미세 이상을 정밀하게 식별하는 제로샷 모델
